...
FullModelcheckpoint = tf.keras.callbacks.ModelCheckpoint("./saved_model_100000_with_pretrained embeddings/FullModelWeights.h5",
...
FullModel.load_weights("./saved_model_100000_with_pretrained embeddings/FullModelWeights.h5")
